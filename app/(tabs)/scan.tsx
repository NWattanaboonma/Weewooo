...
const QUICK_TEST_SCANS = ['MED001', 'EQP001', 'SUP001', 'MED002', 'EQP002', 'SUP002'];
    ...
    if (Platform.OS === 'web') {
      return (
        <View style={styles.cameraPlaceholder}>
          ...
          <Text style={styles.cameraText}>Camera scanning not available on web</Text>
          <Text style={styles.cameraSubtext}>Use manual entry or quick test scans below</Text>
        </View>
      );
    }
      ...
      <>
        ...
        {scanned && (
          <View style={styles.scanIndicator}>
            <IconSymbol name="checkmark.circle.fill" size={40} color="#4ADE80" />
